...
import { Hero } from './AmbulanceLanding/Hero';
import { Features } from './AmbulanceLanding/Features';
...
const AmbulanceList = () => {
  ...
  return (
    <div className="bg-gray-50  py-5 -mt-48  ">
      <Hero />
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-green-700 text-sm">
                    {bookingSuccess.ambulance} ({bookingSuccess.vehicle}) is on
                    the way. Contact:{" "}
                    <a
                      href={`tel:${bookingSuccess.phone}`}
                      className="underline"
                    >
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-red-700 text-sm">
                    {sosSuccess.message} {sosSuccess.ambulancesNotified}{" "}
                    ambulances notified.
                  </p>
                </div>
              </div>
          ...
          {filteredAmbulances.length > 0 ? (
                ...
                <div className="p-6">
                  ...
                  <div className="mb-4 p-3 bg-gray-50 rounded-lg">
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={`text-sm ${getDistanceColor(
                          ambulance.distance
                        )}`}
                      >
            ...
            <div className="col-span-full text-center py-12">
              ...
              <p className="text-gray-600 mb-4">
                No ambulances available within {searchRadius} km of your
                location.
              </p>
              <button
